...
class Base_controller extends database_connection{
	...
	function update_manufaturer() {
		...
		// Add activity logs
		$this->add_to_logs("user_group_id, email, activity, date_added", "'$ses_group_id', '$email', 'Update manufacturer details', '$date_added'");
				...
				if ($_SESSION["user_group"] == 2) {
					$table .= '
						<tr>
							...
							<td>'.$account_name.'</td>
							<td class="text-center">
								<button type="button" class="btn btn-md btn-info" disabled><i class="fas fa-pencil-alt"></i></button>
							</td>
						</tr>
					';
				} else {
					$table .= '
						<tr>
							...
							<td>'.$account_name.'</td>
							<td class="text-center">
								<button type="button" class="btn btn-md btn-info" onclick="update_bank_details(\'' . $bank_id . '\',\'' . $bank_name . '\',\'' . $account_number . '\',\'' . $account_name . '\')"><i class="fas fa-pencil-alt"></i></button>
							</td>
						</tr>
					';
				}
	...
	function update_banks() {
		...
		$conn = $this->db_conn();
		$sql = "UPDATE banks SET bank_name='$bank_name', account_number='$account_number', account_name='$account_name' WHERE bank_id='$bank_id'";
