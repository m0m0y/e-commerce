...
<body id="page-top">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-4">
                                                <label for="meta_tag_title" class="col-sm-3 col-form-label">* Meta Tag Title:</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row mb-4">
                                                <label for="meta_tag_description" class="col-sm-3 col-form-label">Meta Tag Description:</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row mb-4">
                                                <label for="meta_tag_keywords" class="col-sm-3 col-form-label">Meta Tag Keywords</label>
                                                <div class="col-sm-9">
                                                    <textarea id="meta_tag_keywords" name="meta_tag_keywords" rows="4" cols="50" class="form-control" placeholder="Meta Tag Keywords"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                <label for="stock_status" class="col-sm-3 col-form-label">Stock Status</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row mb-4">
                                                <label for="weight_class" class="col-sm-3 col-form-label">Weight Class</label>
                                                <div class="col-sm-9">
    ...
    <script>
        ...
        function update_product(product_id, name, quantity, price, product_status, description, meta_title, meta_description, meta_keywords, stock_status_id, weight, weight_id) {
