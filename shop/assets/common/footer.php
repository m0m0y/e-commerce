    ...
    <div class="container pb-4 pt-4">
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <h5>Information</h5>
                <a href="#" target="blank" class="btn btn-link">About Us</a>
                <br/>
            ...
            <div class="col-sm-12 col-md-3">
                ...
                <a href="#" target="blank" class="btn btn-link">Contact Us</a>
                <br/>
            ...
            <div class="col-sm-12 col-md-3">
                <h5>My Account</h5>
                <a href="#" target="blank" class="btn btn-link">My Account</a>
                <br/>
