    ...
    <section class="mt-5 container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-8"> 
                ...
                <a href="<?= $BASE_URL ?>update_account" class="text-decoration-none">Edit my account Information</a></br>
                <a href="<?= $BASE_URL ?>update_password" class="text-decoration-none">Change your password</a></br>
                <a href="<?= $BASE_URL ?>wishlist" class="text-decoration-none">Modify your wish list</a></br>
